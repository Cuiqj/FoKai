...
#define GDRM_CASE_TYPE_NAME_ARRAY ([[[AppDelegate App].projectDictionary objectForKey:@"projectname"] isEqualToString:@"meida"] ? @[@"佛开高[赔]", @"佛开高[罚]"] : @[@"佛开高[赔]", @"佛开高[罚]"])
...
//配补偿清单时间
@property (nonatomic, retain) NSDate * casedeformation_create_Date;
...
- (NSString *)full_happen_place_forCount;
