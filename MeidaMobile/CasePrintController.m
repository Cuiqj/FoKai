...
NSString * const DocNameKeyPei_PeiBuChangDiaoChaBaoGao            = @"GongLuPeiBuChangDiaoChaBaoGao";
...
NSString * const LocalStringPath=@"/Users/admin/Desktop/FoKai/MeidaMobile/DocTemplates/";
...
- (id)init{
    ...
    self.templateNameDictionary = @{
                                    ...
                                    DocNameKeyPei_PeiBuChangDiaoChaBaoGao:
                                        @"GongLuPeiBuChangDiaoChaBaoGao.xml",
...
//#if TARGET_IPHONE_SIMULATOR
            ...
            NSString *templeXmlPath=[ NSString stringWithFormat:@"%@%@.xml.mustache", LocalStringPath ,templateNameKey];
